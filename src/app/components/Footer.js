...
export default function Footer() {
    ...
    <div class="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        ...
        <div>
            <div class="flex justify-center text-teal-600 sm:justify-start flex-row items-center">
                <Image
              src={"/Logo_Pulsar.png"}
              alt="Logo"
              width={60}
              ...
              className="flex ml-5"
            />
            <h1 class="text-white whitespace-nowrap">Pulsar<br /> Fondation
            </h1>
            </div>
        ...
        <div class="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p class="mt-4 text-sm text-white sm:order-first sm:mt-0">&copy; 2024 Pulsar Fondation. All rights reserved.</p>
        </div>
        </div>
    </div>
    </footer>
